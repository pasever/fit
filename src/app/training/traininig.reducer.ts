...
import { TrainingAction, SET_AVAILABLE_TRAININGS, SET_FINISHED_TRAINING, START_TRAINING, STOP_TRAINING } from "./training.actions";
...
export function authReducer( state = initialState, action: TrainingAction ) {
    switch (action.type) {
